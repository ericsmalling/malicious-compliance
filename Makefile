...
scan-all: scan-0-base scan-1-os scan-2-pkg scan-3-lang scan-4-bin scan-5-zero ## Scans all image variants
results-all: results-0-base results-1-os results-2-pkg results-3-lang results-4-bin results-5-zero ## Shows results for all image variants
...
scan-0-base: trivy-scan-0-base grype-scan-0-base snyk-scan-0-base dockerscout-scan-0-base ## Scan 0-base with all scanners
results-0-base: trivy-results-0-base grype-results-0-base snyk-results-0-base dockerscout-results-0-base ## Show 0-base results for all scanners
...
.PHONY: snyk-scan-0-base
snyk-scan-0-base: ## Snyk container 0-base
	@echo "Scanning 0-base with snyk container"
	@snyk container test $(IMAGEREPO):0-base --json > $(RESULTS_DIR)/snyk-scan-0-base.json || echo "snyk container scanned"
...
.PHONY: snyk-results-0-base
snyk-results-0-base: ## View Snyk container results for 0-base in JSON
	@echo "Snyk Container results from scanning 0-base"
	@cat $(RESULTS_DIR)/snyk-scan-0-base.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | ["snyk-scan", .packageManager,.language,.packageName,.nvdSeverity,.version,.identifiers.CVE[0]]'

.PHONY: snyk-results-0-base-summary
snyk-results-0-base-summary: ## View Snyk container summary results for 0-base
	@echo "Snyk Container results summary 0-base"
	@cat $(RESULTS_DIR)/snyk-scan-0-base.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | .language' | sed -e 's/linux/os-pkg/g' | sed -e 's/golang/binary/g' | uniq -c && echo "   0 runtime/language dependency file"
...
results-0-base-summary: trivy-results-0-base-summary grype-results-0-base-summary snyk-results-0-base-summary dockerscout-results-0-base-summary ## View all results, summarized
...
scan-1-os: trivy-scan-1-os grype-scan-1-os snyk-scan-1-os dockerscout-scan-1-os ## Scan 1-os with all scanners
results-1-os: trivy-results-1-os grype-results-1-os snyk-results-1-os dockerscout-results-1-os ## Show 1-os results for all scanners
...
.PHONY: snyk-scan-1-os
snyk-scan-1-os: ## Snyk scan 1-os
	@echo "Scanning 1-os with snyk container"
	@snyk container test $(IMAGEREPO):1-os --json > $(RESULTS_DIR)/snyk-scan-1-os.json || echo "snyk container scanned"
	@echo "Scanned 1-os with snyk container"
...
.PHONY: snyk-results-1-os
snyk-results-1-os: ## View Snyk container results for 1-os in JSON
	@echo "Snyk Container results from scanning 1-os"
	@cat $(RESULTS_DIR)/snyk-scan-1-os.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | ["snyk-scan", .packageManager,.language,.packageName,.nvdSeverity,.version,.identifiers.CVE[0]]'

.PHONY: dockerscan-results-1-os-summary
snyk-results-1-os-summary: ## View Snyk container summary results for 1-os
	@echo "Snyk Scan results summary 1-os"
	@echo "   0 os-pkg" && cat $(RESULTS_DIR)/snyk-scan-1-os.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | .language' | sed -e 's/linux/os-pkg/g' | sed -e 's/golang/binary/g' | uniq -c && echo "   0 runtime/language dependency file"
...
results-1-os-summary: trivy-results-1-os-summary grype-results-1-os-summary snyk-results-1-os-summary dockerscout-results-1-os-summary ## View all results, summarized
...
scan-2-pkg: trivy-scan-2-pkg grype-scan-2-pkg snyk-scan-2-pkg dockerscout-scan-2-pkg ## Scan 2-pkg with all scanners
results-2-pkg: trivy-results-2-pkg grype-results-2-pkg snyk-results-2-pkg dockerscout-results-2-pkg ## Show 2-pkg results for all scanners
...
.PHONY: snyk-scan-2-pkg
snyk-scan-2-pkg: ## Snyk container scan 2-pkg
	@echo "Scanning 2-pkg with snyk container"
	@snyk container test $(IMAGEREPO):2-pkg --json > $(RESULTS_DIR)/snyk-scan-2-pkg.json || echo "snyk container scanned"
	@echo "Scanned 2-pkg with snyk container"
...
.PHONY: snyk-results-2-pkg
snyk-results-2-pkg: ## View Snyk container results for 2-pkg in JSON
	@echo "Snyk Container results from scanning 2-pkg"
	@cat $(RESULTS_DIR)/snyk-scan-2-pkg.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | ["snyk-scan", .packageManager,.language,.packageName,.nvdSeverity,.version,.identifiers.CVE[0]]'

.PHONY: snyk-results-2-pkg-summary
snyk-results-2-pkg-summary: ## View Snyk container summary results for 2-pkg
	@echo "Snyk Container results summary 2-pkg"
	@echo "   0 os-pkg" && cat $(RESULTS_DIR)/snyk-scan-2-pkg.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | .language' | sed -e 's/linux/os-pkg/g' | sed -e 's/golang/binary/g' | uniq -c && echo "   0 runtime/language dependency file"
...
results-2-pkg-summary: trivy-results-2-pkg-summary grype-results-2-pkg-summary snyk-results-2-pkg-summary dockerscout-results-2-pkg-summary ## View all results, summarized
...
scan-3-lang: trivy-scan-3-lang grype-scan-3-lang snyk-scan-3-lang dockerscout-scan-3-lang ## Scan 3-lang with all scanners
results-3-lang: trivy-results-3-lang grype-results-3-lang snyk-results-3-lang dockerscout-results-3-lang ## Show 3-lang results for all scanners
...
.PHONY: snyk-scan-3-lang
snyk-scan-3-lang: ## Snyk container 3-lang
	@echo "Scanning 3-lang with snyk container"
	@snyk container test $(IMAGEREPO):3-lang --json > $(RESULTS_DIR)/snyk-scan-3-lang.json || echo "snyk container scanned"
	@echo "Scanned 3-lang with snyk container"
...
.PHONY: snyk-results-3-lang
snyk-results-3-lang: ## View Snyk container results for 3-lang in JSON
	@echo "Docker Scan results from scanning 3-lang"
	@cat $(RESULTS_DIR)/docker-scan-3-lang.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | ["docker-scan", .packageManager,.language,.packageName,.nvdSeverity,.version,.identifiers.CVE[0]]'

.PHONY: snyk-results-3-lang-summary
snyk-results-3-lang-summary: ## View Snyk container summary results for 3-lang
	@echo "Snyk Container results summary 3-lang"
	@echo "   0 os-pkg" && cat $(RESULTS_DIR)/snyk-scan-3-lang.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | .language' | sed -e 's/linux/os-pkg/g' | sed -e 's/golang/binary/g' | uniq -c && echo "   0 runtime/language dependency file"
...
results-3-lang-summary: trivy-results-3-lang-summary grype-results-3-lang-summary snyk-results-3-lang-summary dockerscout-results-3-lang-summary ## View all results, summarized
...
scan-4-bin: trivy-scan-4-bin grype-scan-4-bin snyk-scan-4-bin dockerscout-scan-4-bin ## Scan 4-bin with all scanners
results-4-bin: trivy-results-4-bin grype-results-4-bin snyk-results-4-bin dockerscout-results-4-bin ## Show 4-bin results for all scanners
...
.PHONY: snyk-scan-4-bin
snyk-scan-4-bin: ## Snyk container 4-bin
	@echo "Scanning 4-bin with snyk container"
	@snyk container test $(IMAGEREPO):4-bin --json > $(RESULTS_DIR)/snyk-scan-4-bin.json || echo "snyk container scanned"
	@echo "Scanned 4-bin with snyk container"
...
.PHONY: snyk-results-4-bin
snyk-results-4-bin: ## View Snyk container results for 4-bin in JSON
	@echo "Snyk Container results from scanning 4-bin"
	@cat $(RESULTS_DIR)/snyk-scan-4-bin.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | ["snyk-scan", .packageManager,.language,.packageName,.nvdSeverity,.version,.identifiers.CVE[0]]'

.PHONY: snyk-results-4-bin-summary
snyk-results-4-bin-summary: ## View Snyk container summary results for 4-bin
	@echo "Snyk Container results summary 4-bin"
	@echo "   0 os-pkg" && cat $(RESULTS_DIR)/snyk-scan-4-bin.json | jq -rc '.vulnerabilities[], .applications[].vulnerabilities[] | .language' | sed -e 's/linux/os-pkg/g' | sed -e 's/golang/binary/g' | uniq -c && echo "   0 runtime/language dependency file"
...
results-4-bin-summary: trivy-results-4-bin-summary grype-results-4-bin-summary snyk-results-4-bin-summary dockerscout-results-4-bin-summary ## View all results, summarized
...
scan-5-zero:  trivy-scan-5-zero grype-scan-5-zero snyk-scan-5-zero dockerscout-scan-5-zero ## Scan 5-zero with all scanners
results-5-zero: trivy-results-5-zero grype-results-5-zero snyk-results-5-zero dockerscout-results-5-zero ## Show 5-zero results for all scanners
...
.PHONY: snyk-scan-5-zero
snyk-scan-5-zero: ## Snyk container 5-zero
	@echo "Scanning 5-zero with snyk container"
	@snyk container test $(IMAGEREPO):5-zero --json > $(RESULTS_DIR)/snyk-scan-5-zero.json || echo "snyk container scanned"
	@echo "Scanned 5-zero with snyk- container"
...
snyk-results-5-zero: ## View Snyk container results for 5-zero in JSON
	@echo "Snyk Container results from scanning 5-zero"
	@cat $(RESULTS_DIR)/snyk-scan-5-zero.json | jq -rc 'select(.vulnerabilities? != null) | .[] | ["snyk-scan", .packageManager,.language,.packageName,.nvdSeverity,.version,.identifiers.CVE[0]]'

.PHONY: snyk-results-5-zero-summary
snyk-results-5-zero-summary: ## View Snyk container summary results for 5-zero
	@echo "Snyk Container results summary 5-zero"
	@cat $(RESULTS_DIR)/snyk-scan-5-zero.json | jq -rc 'select(.[].vulnerabilities? != null) | .vulnerabilities[], .applications[].vulnerabilities[] | .language' | sed -e 's/linux/os-pkg/g' | sed -e 's/golang/binary/g' | uniq -c && echo "   0 os-pkg" && echo "   0 binary" && echo "   0 runtime/language dependency file"
...
results-5-zero-summary: trivy-results-5-zero-summary grype-results-5-zero-summary snyk-results-5-zero-summary dockerscout-results-5-zero-summary ## View all results, summarized
